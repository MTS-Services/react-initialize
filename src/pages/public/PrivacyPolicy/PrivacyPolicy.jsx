      ...
      <main className="flex justify-center py-8 md:py-10 lg:py-12">
        <div className="w-[90vw] max-w-5xl sm:w-[70vw] lg:w-[80vw]">
          <h2 className="mb-4 max-w-[16rem] text-3xl font-bold text-blue-400 sm:max-w-none">
            Privacy Policy of Rent Alerts
          </h2>
          <p className="mb-4">
            Metis International B.V. operates the www.rentalerts.nl website,
            which provides a service that makes looking for an apartment easier
            and faster. The service contains sending links to newly available
            rental homes to our customers.
          </p>
          <p className="mb-4">
            This page is used to inform website visitors regarding our policies
            with the collection, use, and disclosure of Personal Information if
            anyone decided to use our Service, the Rent Alerts website.
          </p>
          <p className="mb-4">
          ...
          <h4 className="my-4 text-xl font-bold text-blue-400">Log Data</h4>
          <p>
          ...
          <h4 className="my-4 text-xl font-bold text-blue-400">Cookies</h4>
          <p className="mb-4">
          ...
          <h4 className="my-4 text-xl font-bold text-blue-400">Security</h4>
          <p>
          ...
          <h4 className="my-4 text-xl font-bold text-blue-400">Contact Us</h4>
          <p>
            If you have any questions or suggestions about our Privacy Policy,
            do not hesitate to contact us at support@rentalerts.nl.
          </p>
        </div>
      </main>
    </section>
